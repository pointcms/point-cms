    ...
    <div class="col-xl-10 mx-auto">
        ...
        <?php if (has_posts()): ?>
            ...
            <div class="mb-5 posts">
                <article>
                    <h3>
                        <a class="text-decoration-none fw-light text-body" href="<?php echo article_url(); ?>" title="<?php echo article_title(); ?>"><?php echo article_title(); ?></a>
                    </h3>
                    <div class="lead">
                        <?php echo substr(article_description(), 0, 250); ?>
                    </div>
