<?php echo $header; ?>
                ...
                <div class="d-flex mt-3 mb-3">
                    <div class="me-auto p-2"><h3><?php echo __('categories.categories'); ?></h3></div>
                    <div class="p-2">
                        <?php echo Html::link('admin/categories/add', '<i class="bi bi-plus-lg"></i>', [
                            'class' => 'btn btn-outline-secondary',
                            'data-bs-toggle' => 'tooltip',
                            'data-bs-title' =>  __('categories.create_category')
                        ]); ?>
                    </div>
                </div>
