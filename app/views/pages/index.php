<?php echo $header; ?>
    ...
    <div class="d-flex mt-3 mb-3">
        <div class="me-auto p-2"><h3><?php echo __('pages.pages'); ?></h3></div>
        <div class="p-2">
        ...
        <div class="p-2">
            <?php if ($pages->count): ?>
                <?php echo Html::link('admin/menu', '<i class="bi bi-menu-app"></i>', [
                    'class' => 'btn btn-outline',
                    'data-bs-toggle' => 'tooltip',
                    'data-bs-title' => __('menu.edit_menu')
                ]); ?>
                <?php echo Html::link('admin/pages/add', '<i class="bi bi-plus-lg"></i>', [
                    'class' => 'btn btn-outline-secondary',
                    'data-bs-toggle' => 'tooltip',
                    'data-bs-title' => __('pages.create_page')
                ]); ?>
            <?php endif; ?>
        </div>
    </div>
