<?php echo $header; ?>
    ...
    <form id="form-edit" method="post" action="<?php echo Uri::to('admin/extend/metadata'); ?>" novalidate>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-dashboard_page"><?php echo __('metadata.dashboard_page'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-sitename"><?php echo __('metadata.sitename'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-sitedescription"><?php echo __('metadata.sitedescription'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-cookie_policy_page"><?php echo __('metadata.cookie_policy_page'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-posts_per_page"><?php echo __('metadata.posts_per_page'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-auto_published_comments"><?php echo __('metadata.auto_publish_comments'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-comment_notifications"><?php echo __('metadata.comment_notifications'); ?></label>
        ...
        <div class="input-group mt-3 mb-3">
            <label class="input-group-text" for="label-comment_moderation_keys"><?php echo __('metadata.comment_moderation_keys'); ?></label>
