...
class paginator
{
    ...
    public function link($text, $attrs = [])
    {
        ...
        return '<li class="page-item"><a class="page-link"  ' . trim($attr) . '>' . $text . '</a></li>';
    }
    ...
    public function links()
    {
        ...
        if ($pages > 1) {
            if ($this->page > 1) {
                ...
                $html = '<li class="page-item"><a class="page-link" href="' . $this->url . '">' . $this->first . '</a>
                <li class="page-item"><a class="page-link" href="' . $this->url . '/' . $page . '">' . $this->prev . '</a>';
            }
