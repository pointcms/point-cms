...
class notify
{
     ...
     * @var string
     */
    public static $wrap = '<div id="alert">%s</div>';
     ...
     * @var string
     */
    public static $mwrap = '<div class="alert fw-light alert-%s alert-dismissible fade show" role="alert"><div class="container">%s</div>  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
