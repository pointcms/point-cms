...
{
    /**
     * Holds the the blog script update check URL
     */
    const UPDATE_URL = 'https://pixel.com.ro/version/';
    ...
    /**
     * Upgrades the blog script installation
     *
     * @param string $url
    ...
    public static function upgrade($url, $version)
    {
        ...
        $result        .= '|-|Creating \'app_update\' folder.';
        $output_folder = PATH . "app_update" . DS;
        ...
        try {
            ...
            if (($zipCode = $zip->open($output_file)) === true) {
                ...
                $result .= '|-|Recursive copy of \'/app/\', \'/system/\', and \'/index.php\'.';

                recurse_copy($output_folder . "app", APP);
