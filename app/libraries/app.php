...
class app
{
    ...
    public static function register()
    {
        ...
        Registry::set('cookie_policy_page', Page::cookie_policy_page());
        ...
        if ( ! is_admin()) {
            ...
            // register menu items
            $pages_footer = Page::where('status', '=', 'published')
                ->where('show_in_footer', '=', '1')
                ->sort('footer_order')
                ->get();

            $pages_footer = new Items($pages_footer);

            Registry::set('information', $pages_footer);
            Registry::set('total_information_items', $pages_footer->length());
