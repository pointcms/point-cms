...
Route::get('database', [
    ...
    'main'   => function () {
        ...
        if ( ! Session::get('install.i18n')) {
            Notify::error('<p class="lead">Please select a language</p>');
...
Route::post('database', [
    ...
    'main'   => function () {
        ...
        try {
            ...
            Input::flash();
            Notify::error('<p class="lead">'.$e->getMessage().'</p>');
...
Route::get('metadata', [
    ...
    'main'   => function () {
        ...
        if ( ! Session::get('install.database')) {
            Notify::error('<p class="lead">Please enter your database details</p>');
...
Route::get('account', [
    ...
    'main'   => function () {
        ...
        if ( ! Session::get('install.metadata')) {
            Notify::error('<p class="lead">Please enter your site details</p>');
...
Route::get('complete', function () {
    ...
    if ( ! Session::get('install')) {
        Notify::error('<p class="lead">Please select your language</p>');
